                    ...
                    if (data.results.length == 0) {
                        ...
                        $.each(data.results, function (i, item) {
                            $("#results").append(
                                ...
                                "<div class=\"col s3\">" +
                                "<img style=\"width: 200px;display: block;background-image: url(\'/img/loading.gif\');background-repeat: no-repeat;background-position: 50% 50%;background-size: 50%;\" data-src=\"" + item.thumbnail + "\" class=\"circle lazy\">" +
                                "</div>" +
                                "<div class=\"col s9\">" +
